...
- (void)viewDidLoad
{
    ...
    UIPlaceHolderTextView *resultView = [[UIPlaceHolderTextView alloc] initWithFrame:
                                         CGRectMake(_DEMO_UI_MARGIN*2, _DEMO_UI_MARGIN*2, self.view.frame.size.width-_DEMO_UI_MARGIN*4, 300)];
    ...
    button.frame = CGRectMake(_DEMO_UI_MARGIN*2, resultView.frame.origin.y+resultView.frame.size.height+_DEMO_UI_PADDING, self.view.frame.size.width-_DEMO_UI_MARGIN*4, 50);
