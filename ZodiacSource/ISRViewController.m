...
- (void)loadView
{
    ...
    self.view = mainView;
    int top = _DEMO_UI_MARGIN*2;
    //听写
    self.title = @"语音听写";
    UIPlaceHolderTextView *resultView = [[UIPlaceHolderTextView alloc] initWithFrame:
                              CGRectMake(_DEMO_UI_MARGIN*2, top, self.view.frame.size.width-_DEMO_UI_MARGIN*4, 160)];
    ...
    startBtn.frame = CGRectMake(_DEMO_UI_PADDING, resultView.frame.origin.y + resultView.frame.size.height + _DEMO_UI_PADDING, (self.view.frame.size.width-_DEMO_UI_PADDING*4)/3, _DEMO_UI_BUTTON_HEIGHT);
    ...
    stopBtn.frame = CGRectMake(startBtn.frame.origin.x+ _DEMO_UI_PADDING + startBtn.frame.size.width, startBtn.frame.origin.y, (self.view.frame.size.width-_DEMO_UI_PADDING*4)/3, _DEMO_UI_BUTTON_HEIGHT);
    ...
    cancelBtn.frame = CGRectMake(stopBtn.frame.origin.x+ _DEMO_UI_PADDING + stopBtn.frame.size.width, stopBtn.frame.origin.y, stopBtn.frame.size.width, stopBtn.frame.size.height);
...
//    [self.view addSubview:customLabel];
    ...
    engineBtn.frame = CGRectMake(startBtn.frame.origin.x, stopBtn.frame.origin.y + stopBtn.frame.size.height + _DEMO_UI_PADDING*2, self.view.frame.size.width-_DEMO_UI_PADDING*2, stopBtn.frame.size.height);
    ...
    uploadContactBtn.frame = CGRectMake(_DEMO_UI_PADDING, engineBtn.frame.origin.y + engineBtn.frame.size.height+_DEMO_UI_PADDING, self.view.frame.size.width-_DEMO_UI_PADDING*2, _DEMO_UI_BUTTON_HEIGHT);
    ...
    uploadWordBtn.frame = CGRectMake(_DEMO_UI_PADDING, uploadContactBtn.frame.origin.y + uploadContactBtn.frame.size.height + _DEMO_UI_PADDING, uploadContactBtn.frame.size.width, _DEMO_UI_BUTTON_HEIGHT);
...
-(void) onUploadContact:(id)sender
{
    ...
    if(!contact || [contact length]< 1 ){
        [self.popUpView setText:@"获取联系人失败"];
