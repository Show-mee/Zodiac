...
//        self.highlitedIconColor = [UIColor colorWithRed:0.75 green:0.00f blue:0.00f alpha:0.00f];
        self.highlitedIconColor = [UIColor colorWithRed:98/255.0f green:29/255.0f blue:29/255.0f alpha:0.0f];
