...
- (void)viewDidLoad
{
    ...
    audiobtn.frame = CGRectMake(_DEMO_UI_PADDING, custom.frame.origin.y + custom.frame.size.height+10, self.view.frame.size.width-_DEMO_UI_PADDING*2, _DEMO_UI_BUTTON_HEIGHT);
